            ...
            PendingResult<AutocompletePredictionBuffer> results =
                    Places.GeoDataApi
                            .getAutocompletePredictions(mGoogleApiClient, constraint.toString(),
                                    new LatLngBounds.Builder().include(new LatLng(-0, 0)).build(),
                                    autocompleteFilter);
...
//                        Toast.LENGTH_SHORT).show();
            ...
            ArrayList<PlaceAutocomplete> resultLifst = new ArrayList<>(autocompletePredictions.getCount());

            while (iterator.hasNext()) {
                AutocompletePrediction prediction = iterator.next();
                resultLifst.add(new PlaceAutocomplete(prediction.getPlaceId(),
                        prediction.getPrimaryText(STYLE_BOLD),prediction.getSecondaryText(STYLE_BOLD),prediction.getFullText(STYLE_BOLD)));
    ...
    public void onBindViewHolder(@NonNull PlaceViewHolder mPredictionHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        mPredictionHolder.mAddress1.setText((CharSequence) mResultList.get(i).description1);
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceViewHolder(View itemView) {
            ...
            mAddress1 = (TextView)itemView.findViewById(R.id.address2);
        }
    ...
    public class PlaceAutocomplete {
        ...
        public CharSequence description1;

        PlaceAutocomplete(CharSequence placeId, CharSequence description, CharSequence description1, CharSequence fullDescription) {
