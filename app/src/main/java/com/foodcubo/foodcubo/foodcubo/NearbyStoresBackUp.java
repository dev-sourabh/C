...
public class NearbyStoresBackUp extends AppCompatActivity implements RestaurantListAdapter.RestaurantListClickInterface,RatingDialogListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener  {
    ...
    public void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .create(NearbyStoresBackUp.this)
                .show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Common.isConnectedToInternet(NearbyStoresBackUp.this))
            getUserLocation();
        else
            Toast.makeText(NearbyStoresBackUp.this,"Please check your connection!!!!",Toast.LENGTH_SHORT).show();
...
//                                System.out.println("im dddddddddin..."+dataSnapshot);
                                ...
                                for (DataSnapshot snapshot: dataSnapshot.getChildren()) {
                                    ...
                                    if(distanceInMeters < 2000){
                                        ...
                                        System.out.println("huhu...."+snapshot.getKey()+"..."+
                                                snapshot.child("name").getValue(String.class)+"..."+
                                                snapshot.child("image").getValue(String.class)+"..."+
                                                snapshot.child("phoneNo").getValue(String.class));
                                ...
                                adapter = new RestaurantListAdapter(NearbyStoresBackUp.this, restaurantsNearBy);
                                //set adapter
        ...
        dialog.setTitle("Enable Location")
                ...
                .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                        ...
                        ActivityCompat.requestPermissions(NearbyStoresBackUp.this,
                                new String[]{ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION},
                                MY_PERMISION_CODE);
        ...
        ratingTbl.push()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(NearbyStoresBackUp.this,"Thank you for submit rating !!!",Toast.LENGTH_SHORT).show();
                    }
                });
        }else{
        Common.reopenApp(NearbyStoresBackUp.this);
    }
