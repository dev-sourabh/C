package com.foodcubo.foodcubo.foodcubo.materialsearchview;
...
import com.foodcubo.foodcubo.android.materialsearchview.SearchAdapter;
import com.foodcubo.foodcubo.foodcubo.materialsearchview.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public MaterialSearchView(Context context, SearchViewListener mSearchViewListener) {
    ...
    public void setMargin(int margin){
        LinearLayout.LayoutParams linearParams =
                (LinearLayout.LayoutParams) mSearchTopBar.getLayoutParams();
        linearParams.setMargins(0, 0, margin, 0);
        mSearchTopBar.setLayoutParams(linearParams);
        mSearchTopBar.requestLayout();
    }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter instanceof Filterable) {
            ((Filterable) this.mAdapter).getFilter().filter(s, MaterialSearchView.this);
        }
    }
    ...
    private void onVoiceClicked() {
        ...
        if (mContext instanceof AppCompatActivity) {
            ((AppCompatActivity) mContext).startActivityForResult(intent, REQUEST_VOICE);
        }
    }
